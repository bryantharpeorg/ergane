...
- [x] T001 [US1] (spec US1-S1) Write the degradation case FIRST: a roadmap query
...
- [x] T002 [P] [US1] (spec US1-S2) Write the transport-path case FIRST: an
...
- [x] T003 [P] [US1] (spec US1-S3) Write the guarded-types case FIRST: assert by
      ...
      raise. Must fail.
- [x] T004 [P] [US1] (spec US1-S4, FR-004) Write the no-bare-catch case FIRST:
...
- [x] T005 [US1] Catch what the client raises at `factory/cli/status.py:435`,
...
- [x] T006 [US1] Commit the SC-001 transcript: `ergane status specs` against the
