...
**Feature Branch**: `non_mapping`

**Created**: 2026-08-05

**Status**: Draft

**Input**: Deriver fixture — rejection (`mapping`): the fenced block is a YAML
sequence of story ids rather than a mapping of story id to declaration. No story can
be named, so the error names the rule.
