...
**Feature Branch**: `unknown_fr`

**Created**: 2026-08-05

**Status**: Draft

**Input**: Deriver fixture — rejection (`implements`): US2 claims to implement FR-404,
which the spec does not declare. The error names US2.
