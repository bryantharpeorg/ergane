...
**Feature Branch**: `unknown_story`

**Created**: 2026-08-05

**Status**: Draft

**Input**: Deriver fixture — rejection (`story_id`): every story in the spec is
declared, plus US4, which the spec does not declare. The error names US4.
