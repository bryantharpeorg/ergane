...
**Feature Branch**: `unknown_dep`

**Created**: 2026-08-05

**Status**: Draft

**Input**: Deriver fixture — rejection (`depends_on`): US2 depends on US9, which is
neither declared here nor a story in the spec. The error names US2.
