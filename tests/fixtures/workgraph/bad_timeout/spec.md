...
**Feature Branch**: `bad_timeout`

**Created**: 2026-08-05

**Status**: Draft

**Input**: Deriver fixture — rejection (`timeout`): US2 declares `timeout: 0`. It is
an integer, so a deriver that only type-checks accepts it; zero seconds is not a
deadline any attempt can meet. The error names US2.
