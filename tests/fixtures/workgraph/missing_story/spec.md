...
**Feature Branch**: `missing_story`

**Created**: 2026-08-05

**Status**: Draft

**Input**: Deriver fixture — rejection (`coverage`): the spec declares US1, US2 and
US3, but the block declares only US1 and US2. US3 would become a silent orphan; the
error names US3.
