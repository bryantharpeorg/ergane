...
from tests.test_ergane_init import DEFAULT_ANSWERS, ScriptedPrompter, _git, _invoke
...
def test_init_creates_specs_directory(
    init: Callable[..., Any], tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
