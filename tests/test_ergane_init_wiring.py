...
def answers(*, gates: str = TWO_GATES, landing_branch: str = "main", slug: str = "myapp", stack: str = "") -> list[str]:
    """version, runtime, gates, timeouts, standards, landing branch, roadmap, forge,
    writes, caches, diff_refusal_bytes, detected stack, template source, slug."""
    return [
        str(_SUPPORTED_VERSION), "bwrap", gates, "", "", landing_branch, "", "", "", "", "", stack, "",
        slug,
    ]
