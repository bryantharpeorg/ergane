...
def _validate_without_fixes_layer(
    ...
    # The rebinding lands on `factory.spec.composition` (133-US9, FR-015): a rebinding on the CLI noun module disables nothing, and this helper keeps its old line span.
