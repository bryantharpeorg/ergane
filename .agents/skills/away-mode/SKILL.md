...
compatibility: "Requires the ergane CLI on PATH via scripts/ergane-env.sh, gh authenticated, a checkout of this repository, and the ergane-worker/-temporal/-bridge user units running"
metadata:
